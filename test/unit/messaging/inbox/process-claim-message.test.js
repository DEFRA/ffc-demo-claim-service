...
describe('process claim message', () => {
  ...
  test('should process claim message if no error', async () => {
    const claim = {
      claimId: 'claim101',
      name: 'mine123',
      propertyType: 'home',
    ...
    const claimReceiver = new adpMessaging.MessageReceiver()
  ...
  test('should not process claim message if error', async () => {
