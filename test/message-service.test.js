...
jest.mock('../server/services/messaging/rhea-message-receiver')
...
const MessageReceiver = require('../server/services/messaging/rhea-message-receiver.js')
...
describe('Test message service', () => {
  ...
  beforeAll(async () => {
    ...
    messageService = require('../server/services/rhea-message-service')
